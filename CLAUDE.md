...
### Model Types
- **Core models** (tag: `core-models`): `ep`, `wp`, `wp_calibration`, `shot`, `match_gams`, `match_xgb_pipeline`, `shot_player_df`, `xgb_win_model` — loaded via `load_torp_model()`
